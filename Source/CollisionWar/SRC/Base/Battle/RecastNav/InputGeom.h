...
class COLLISIONWAR_API InputGeom
{
	rcChunkyTriMesh* m_chunkyMesh;
	rcMeshLoaderObj* m_mesh = 0;
	...
	bool loadMesh(class rcContextTP* ctx, const std::string& filepath);
	bool loadGeomSet(class rcContextTP* ctx, const std::string& filepath);
public:
	InputGeom();
	~InputGeom();


	bool load(class rcContextTP* ctx, const std::string& filepath);
