...
The standard navigation mesh build process is to create tile data using dtCreateNavMeshDataTP, then add the tile 
to a navigation mesh using either the dtNavMeshTP single tile <tt>init()</tt> function or the dtNavMeshTP::addTile()
function.
