...
void dtFreeTileCacheLayerTP(dtTileCacheAlloc* alloc, dtTileCacheLayer* layer);

dtStatus dtDecompressTileCacheLayerTP(dtTileCacheAlloc* alloc, dtTileCacheCompressor* comp,
									unsigned char* compressed, const int compressedSize,
									dtTileCacheLayer** layerOut);

dtTileCacheContourSet* dtAllocTileCacheContourSetTP(dtTileCacheAlloc* alloc);
void dtFreeTileCacheContourSetTP(dtTileCacheAlloc* alloc, dtTileCacheContourSet* cset);

dtTileCachePolyMesh* dtAllocTileCachePolyMeshTP(dtTileCacheAlloc* alloc);
void dtFreeTileCachePolyMeshTP(dtTileCacheAlloc* alloc, dtTileCachePolyMesh* lmesh);

dtStatus dtMarkCylinderAreaTP(dtTileCacheLayer& layer, const float* orig, const float cs, const float ch,
							const float* pos, const float radius, const float height, const unsigned char areaId);

dtStatus dtMarkBoxAreaTP(dtTileCacheLayer& layer, const float* orig, const float cs, const float ch,
...
bool dtTileCacheHeaderSwapEndianTP(unsigned char* data, const int dataSize);
