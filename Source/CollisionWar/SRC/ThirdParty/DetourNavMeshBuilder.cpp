...
/// mesh.
///
/// @see dtNavMeshTP, dtNavMeshTP::addTile()
bool dtCreateNavMeshDataTP(dtNavMeshCreateParams* params, unsigned char** outData, int* outDataSize)
{
...
bool dtNavMeshHeaderSwapEndianTP(unsigned char* data, const int /*dataSize*/)
{
...
/// Call #dtNavMeshHeaderSwapEndianTP() first on the data if the data is expected to be in wrong endianess 
/// to start with. Call #dtNavMeshHeaderSwapEndianTP() after the data has been swapped if converting from 
/// native to foreign endianess.
bool dtNavMeshDataSwapEndianTP(unsigned char* data, const int /*dataSize*/)
{
