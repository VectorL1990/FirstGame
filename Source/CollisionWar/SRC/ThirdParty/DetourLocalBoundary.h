...
public:
	...
	bool isValid(dtNavMeshQueryTP* navquery, const dtQueryFilter* filter);
...
private:
	...
	dtLocalBoundaryTP(const dtLocalBoundaryTP&);
	dtLocalBoundaryTP& operator=(const dtLocalBoundaryTP&);
};
