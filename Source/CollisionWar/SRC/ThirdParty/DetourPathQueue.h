...
public:
	...
	bool init(const int maxPathSize, const int maxSearchNodeCount, dtNavMeshTP* nav);
	...
	inline const dtNavMeshQueryTP* getNavQuery() const { return m_navquery; }

private:
	// Explicitly disabled copy constructor and copy assignment operator.
	dtPathQueueTP(const dtPathQueueTP&);
	dtPathQueueTP& operator=(const dtPathQueueTP&);
};
