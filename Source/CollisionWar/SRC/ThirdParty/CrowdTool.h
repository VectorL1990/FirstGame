...
class CrowdToolState : public SampleToolState
{
	...
	dtObstacleAvoidanceDebugDataTP* m_vod;
...
public:
	...
	virtual void init(class Sample* sample, float agentPlacementXCoe, float agentPlacementYCoe, float agentPlacementZCoe);
	virtual void reset();
	...
	void addAgent(const float* pos,int agentMark, bool isPlayerAgent, float radius, float height, float maxV, float maxAcc);
	...
	void SetAgentDxByMark(int mark);
...
public:
	...
	virtual void HandleAddAgent(const float* p, int agentMark, bool isPlayerAgent, float radius, float height, float maxV, float maxAcc) override;
	virtual void HandleDeleteAgent(int agentMark) override;
	virtual void HandleRemoveAgent(int i) override;
	virtual void HandleSetAgentMoveTarget(int mark, const float* des) override;
};
