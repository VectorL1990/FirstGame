...
public:
	...
	///  @param[in]		navquery	The query object used to build the corridor.
	///  @param[in]		filter		The filter to apply to the operation.	
	bool optimizePathTopology(dtNavMeshQueryTP* navquery, const dtQueryFilter* filter);
	...
	///  @param[in]		navquery		The query object used to build the corridor.
	///  @param[in]		filter			The filter to apply to the operation.	
	bool isValid(const int maxLookAhead, dtNavMeshQueryTP* navquery, const dtQueryFilter* filter);
	...
	bool movePosition(const float* npos, dtNavMeshQueryTP* navquery, const dtQueryFilter* filter);
	...
	///  @param[in]		filter		The filter to apply to the operation.
	/// @return Returns true if move succeeded.
	bool moveTargetPosition(const float* npos, dtNavMeshQueryTP* navquery, const dtQueryFilter* filter);
...
private:
	...
	dtPathCorridorTP(const dtPathCorridorTP&);
	dtPathCorridorTP& operator=(const dtPathCorridorTP&);
};
